...
import MarmitaLogo from '/img/logoMarmitaSaudavel.jpg';
import produtos from './data';

// Importe os componentes de avaliação
import RatingForm from '../../../components/RatingForm';
import RatingList from '../../../components/RatingList';

const MarmitaSaudavel = () => {
  ...
  // Função para adicionar nova avaliação ao estado
    ...
    <>
      ...
      <section className="restaurant-banner">
        <div className="restaurant-logo">
          <img src={MarmitaLogo} alt="Logo Marmita Saudavel" />
        </div>
        <div className="restaurant-details">
          <h1>Marmita Saudavel</h1>
      ...
      <section className="avaliacoes">
        <h2>Avaliações</h2>
        <RatingForm restauranteId="marmita-saudavel" onAvaliar={handleNovaAvaliacao} />
...
export default MarmitaSaudavel;
