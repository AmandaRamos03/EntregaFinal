...
import pizzariaLogo from '/img/logoZe.png';
import produtos from './data';

// Importa os componentes de avaliação (RatingForm e RatingList)
import RatingForm from '../../../components/RatingForm';
import RatingList from '../../../components/RatingList';

const PizzariaDoSeuZe = () => {
  ...
  // Função que adiciona uma nova avaliação ao estado
    ...
    <>
      ...
      {carrinhoAberto && (
        <div id="carrinhoAba" className="carrinho-lateral">
          ...
          <p>
            <strong>Total:</strong> R$ {parseFloat(total) + 5}
          </p>
      ...
      <section className="restaurant-banner">
        <div className="restaurant-logo">
          <img src={pizzariaLogo} alt="Logo Pizzaria do Seu Zé" />
        </div>
        <div className="restaurant-details">
          <h1>Pizzaria do Seu Zé</h1>
          <p>Aberta até: 23:00</p>
          <p>Mínimo do Pedido: R$ 20,00</p>
          <p>Tempo de entrega: 30–45 min</p>
        </div>
      </section>
      ...
      {/* Seção para o Sistema de Avaliação */}
      <section className="avaliacoes">
        <h2>Avaliações</h2>
        <RatingForm restauranteId="pizzaria-do-seu-ze" onAvaliar={handleNovaAvaliacao} />
...
export default PizzariaDoSeuZe;
